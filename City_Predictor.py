...
#parameters = [location, size, key, heading, fov, pitch, radius]
...
def input_url_builder(location,size,key,heading=None,fov=None,pitch=None,radius=None):
	...
	return GMAPS_URL + urlencode(params)
